...
public class MiLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      List<Cuentas> list = DBDAO.getCuentas("SELECT * FROM Cuentas WHERE nick='"+ request.getParameter("userName") + "' and password ='"+ request.getParameter("userPassword")+"';");
      if(list.size() > 0){
          c = list.get(0);
        ...
        System.out.println("NOEncontrado");
         ...
         response.getWriter().write("encontrado"); 
        }
